...
import {ForgetMobileSchema,ChanePasswordSchema} from '../../utils/ValidationSchema'
        ...
        <div className="singup_overlap-group">
          <div className="group-622">
            ...
            <div className="group-176 mb-4">
              <h1 className="title dmserifdisplay-normal-cod-gray-34px">Reset Password</h1>
              <p className="text-1 dmsans-normal-dove-gray-16px">Enter your registered email and we’ll send you a password reset link to it.</p>
            </div>
            ...
            <Col span={12}> 
                <div className="singup_overlap-group">
                    <div className="group-622">
                        ...
                        <div className="group-176 mb-4">
                            <h1 className="title dmserifdisplay-normal-cod-gray-34px">OTP Verification</h1>
                            <p className="text-1 dmsans-normal-dove-gray-16px">Please enter the OTP sent to mobile number 9876543210.</p>
                ...
                <div className="singup_overlap-group">
                    <div className="group-622 emailsection">
                        ...
                        <div className="group-176 mb-4 text-center">
                            <h1 className="title dmserifdisplay-normal-cod-gray-34px text-center">Email sent</h1>
                            <p className="text-1 dmsans-normal-dove-gray-16px">We have sent an email with password reset link to e******@example.com</p>
                            <a onClick={(()=>skipEmailVerification())} className="skip">I’ll confirm later</a>
                        </div>                        
                    </div>
                </div>
            </Col>
  ...
  renderPasswordChange(){
    ...
    <div className="group-624 singup" id="singup">
        ...
        <div className="group-622">
            ...
            <div className="group-176 mb-4">
            <h1 className="title dmserifdisplay-normal-cod-gray-34px">Create new password</h1>
            <p className="text-1 dmsans-normal-dove-gray-16px">Your new password must be different from previous used passwords.</p>
            </div>
                <div className="group-621">
                    <Formik
                    enableReinitialize={true}
    ...
    return(
          <>
                <div>      
                  ...
                  {verificationStatus && !isChangePassword ? this.renderEmailVerfication():''}
