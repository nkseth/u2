             ...
             <>             
                ...
                <div className="group-639" id="header">
                    ...
                    <Row>
                        ...
                        <div className="logo valign-text-middle quicksand-bold-black-45px">LOGO</div>
                        ...
                        <Navbar  expand="sm">
                            ...
                            <Navbar.Collapse id="basic-navbar-nav">
                                ...
                                <Nav.Link href="#home" className="mr-4">New arrivals</Nav.Link>
                                <Nav.Link href="#link" className="mr-4">Men</Nav.Link>
                                <Nav.Link href="#link" className="mr-4">Women</Nav.Link>
                                <Nav.Link href="#link" className="mr-4">Kids</Nav.Link>
                                ...
                                <Nav.Link href="#link" className="mr-4">Contemporary</Nav.Link>
                                <Nav.Link href="#link" className="mr-4">Offers</Nav.Link>
                        ...
                        <div className="flex-col-1">
                            <div className="group-630">
                                ...
                                <div className="overlap-group1-3">
                                    ...
                                    <span>
                                        <span className="span0-1 dmsans-bold-black-18px"> India</span>
                                        <span className="span1-1 dmsans-bold-black-20px">(&nbsp;&nbsp;)</span>
                                    </span>
                                    </div>
                                    <img
                                    className="polygon-1"
                            ...
                            <div className="group-196">
                                ...
                                />
                                <input placeholder={'Search for designers, brands and more'} className="form-control subtext-4 valign-text-middle dmsans-normal-star-dust-13px"/>
