...
import TopCategoryComponent from "./TopCatagoryContainer.component";
...
class TopCategoryContainer extends PureComponent{
    static propTypes = {
...
export default connect(mapStateToProps,mapDispatchToProps)(TopCategoryContainer);