...
import { set_basic_details, set_basic_id } from "../../Redux/actions/measurement";
        ...
        <div className={styles.genderContainer}>
          ...
          <div className={styles.detailsDiv}>
            ...
            <div className={styles.inputFieldDiv}>
              <div>
                <InputField value={name} setValue={(val)=> dispatch(set_basic_details({...basic_details, name:val}))} label='Name' />
                <InputField value={age} setValue={(val)=> dispatch(set_basic_details({...basic_details, age:val}))} label='Age' />
              </div>
              <div>
                <InputField value={height} setValue={(val)=> dispatch(set_basic_details({...basic_details, height:val}))} label='Height' />
                <InputField value={weight} setValue={(val)=> dispatch(set_basic_details({...basic_details, weight:val}))} label='Weight' />
              </div>
            </div>
