import { FormControl, FormHelperText, IconButton, InputLabel, makeStyles, NativeSelect, Radio, TextField, useMediaQuery } from '@material-ui/core'
            ...
            <div className={styles.Popup}>
                ...
                <div className={styles.newAddressContainer} >
                    ...
                    <div className={styles.formDiv}>
                        <InputField
                            notimp
                            style={BreakPoint && !BreakPointSmall && !BreakPointExtraSmall && !BreakPointMobile ? { minWidth: "345px", marginBottom: "2em" } : BreakPointSmall && BreakPoint && !BreakPointExtraSmall && !BreakPointMobile ? { minWidth: "320px", marginBottom: "2em" } : BreakPoint && BreakPointSmall && BreakPointExtraSmall && !BreakPointMobile ? { minWidth: "250px", marginBottom: "2em" } : BreakPoint && BreakPointSmall && BreakPointExtraSmall && BreakPointMobile ? { minWidth: "70vw", marginBottom: "2em" } : { width: "100%", maxWidth: "380px", minWidth: "380px", marginBottom: "2em" }}
                            label='Name'
