import { FormControl, FormHelperText, InputLabel, makeStyles, NativeSelect, Radio, TextField, useMediaQuery } from '@material-ui/core'
...
function NewAddress() {
    ...
    const BreakPointExtraSmall = useMediaQuery("(max-width:705px)");
    ...
    return (
        <div className={styles.newAddressContainer} >
            ...
            <div className={styles.formDiv}>
                <InputField
                    notimp
                    style={BreakPoint && !BreakPointSmall && !BreakPointExtraSmall && !BreakPointMobile ? { minWidth: "345px", marginBottom: "2em" } : BreakPointSmall && BreakPoint && !BreakPointExtraSmall && !BreakPointMobile ? { minWidth: "320px", marginBottom: "2em" } : BreakPoint && BreakPointSmall && BreakPointExtraSmall && !BreakPointMobile ? { minWidth: "250px", marginBottom: "2em" } : BreakPoint && BreakPointSmall && BreakPointExtraSmall && BreakPointMobile ? { minWidth: "90vw", marginBottom: "2em" } : { width: "100%", maxWidth: "380px", minWidth: "380px", marginBottom: "2em" }}
                    label='Name'
            ...
            <InputField
                textfield
                notimp
                style={{ width: "100%", height: "160px", display: "flex", alignItems: "center", }}
