import { Button, useMediaQuery, FormControl, RadioGroup, FormControlLabel, Radio, Drawer, withStyles } from '@material-ui/core';
            ...
            {mobileView && (
                <div>
                            ...
                            <FormControl style={{width:'100%'}} component="fieldset">
                                ...
                                >
                                    <FormControlLabel
                                        value="Best Match"
                                        control={<CustomRadio />}
                                        label={<span className={styles.radioLabel}>Best Match </span>}
                                    />
                                    <hr className={styles.divider}/>
                                    <FormControlLabel
                                        value="Price: High to Low"
                                        control={<CustomRadio />}
                                        label={<span className={styles.radioLabel}>Price: High to Low</span>}
                                    />
                                    <hr className={styles.divider}/>
                                    <FormControlLabel
                                        value="Price: Low to High"
                                        control={<CustomRadio />}
                                        label={<span className={styles.radioLabel}> Price: Low to High</span>}
                                    />
                                    <hr className={styles.divider}/>
                                    <FormControlLabel
                                        value="New Arrivals"
                                        control={<CustomRadio />}
                                        label={<span className={styles.radioLabel}>New Arrivals</span>}
                                    />
                                    <hr className={styles.divider}/>
                                    <FormControlLabel
                                        value="Most liked"
                                        control={<CustomRadio />}
                                        label={<span className={styles.radioLabel}>Most liked</span>}
                                    />
                                    <hr className={styles.divider}/>
                                    <FormControlLabel
                                        value="Discount: High to Low"
                                        control={<CustomRadio />}
                                        label={<span className={styles.radioLabel}>Discount: High to Low</span>}
                                    />
                    ...
                    <Drawer
                        ...
                        transitionDuration={600}
                    >
                        <FilterMobile  filter={isFilterOpen}/>
                    </Drawer>
