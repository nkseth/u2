        ...
        <div className={styles.container}>
                ...
                >
                    ...
                    >
                        ...
                        <FormControlLabel
                            ...
                            control={<CustomRadio />}
                            label={<p className={styles.radioBtnsLabels}>₹3000 to ₹6,000 (900)</p>}
                        />
                        <FormControlLabel
                            value='₹10,000 to ₹15,000 (300)'
                            control={<CustomRadio />}
                            label={<p className={styles.radioBtnsLabels}>₹10,000 to ₹15,000 (300)</p>}
                        />
                        <FormControlLabel
                            value='₹20,000 to ₹30,000 (100)'
                            control={<CustomRadio />}
                            label={<p className={styles.radioBtnsLabels}>₹20,000 to ₹30,000 (100)</p>}
                        />
                    </RadioGroup>
            ...
            <Accordion className={styles.accordion}>
                ...
                <AccordionDetails className={styles.accordionDetials}>
                    ...
                    <span className={styles.more}> <a>More</a> </span>
                </AccordionDetails>
            </Accordion>
